...
class NumberAnalyzer(object):
    ...
    def parse_data(self):
        ...
        return (["Country",country],["Region",region],["City",city],["Location",location],
                ["Postal",postal],["Timezone",timezone],["Server",server],["Hostname",hostname],["Supplier",supplier],["IP",ip])
    
    def __str__(self):
        return str(f"\{tabulate(self.parse_data)}")
    
if __name__=="__main__":
    os.system("cls")
    print("[simcard analyzer-python genius]\n")
